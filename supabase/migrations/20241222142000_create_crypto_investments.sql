-- Migration: Create crypto_investments table
-- Created: 2024-12-22
-- Description: Creates crypto_investments table for cryptocurrency investment transactions with RLS policies, triggers, and auto-calculation functions
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tgname = 'update_crypto_investments_updated_at'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
        WHERE tgname = 'calculate_crypto_investment_trigger'
    ) THEN
