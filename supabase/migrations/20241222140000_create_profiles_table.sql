...
-- Created: 2024-12-22
-- Description: Creates comprehensive user profiles table with RLS policies, triggers, and functions
...
-- This policy will be created only if admin_users table exists
DO $$
BEGIN
  IF EXISTS (
